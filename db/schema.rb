...
ActiveRecord::Schema.define(version: 2024_11_05_112127) do
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.index ["address", "hp"], name: "index_posts_on_address_and_hp_unique", unique: true
    t.index ["title", "introduction"], name: "index_posts_on_title_and_introduction"
  ...
  create_table "tags", force: :cascade do |t|
    ...
    t.index ["english_word"], name: "index_tags_on_english_word"
